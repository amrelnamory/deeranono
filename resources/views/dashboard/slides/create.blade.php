...
@section('title')
    @Lang('site.slides') | @Lang('site.add_slide')
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@Lang('site.add_slide')</li>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@Lang('site.add_slide')</h3>
                        </div>
                        <div class="card-body pt-3 pb-3">
                            <!-- /.card-header -->
                            <div class="container-fluid">

                                <form action="{{ route('dashboard.slides.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        <img src="{{ asset('uploads/categories_images/not-found.jpg') }}"
                                            style="width: 150px" class="img-thumbnail image-preview" alt="">
                                    </div>
