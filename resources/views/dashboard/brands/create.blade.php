...
@section('title')
    @Lang('site.brands') | @Lang('site.add_brand')
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@Lang('site.add_brand')</li>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@Lang('site.add_brand')</h3>
                        </div>
                        <div class="card-body pt-3 pb-3">
                            ...
                            <div class="container-fluid">
                                ...
                                <form action="{{ route('dashboard.brands.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        <img src="{{ asset('uploads/brands_images/not-found.jpg') }}"
