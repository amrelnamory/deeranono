...
@section('content')
            ...
            @foreach ($slides as $slide)
                <div>
                    <div class="home text-center">
                        <img src="{{ $slide->image_path }}" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
        ...
        <div class="container">
            <div class="row margin-default">
                <div class="col-lg-3 d-lg-block d-none">
                    <div class="h-100">
                        <img src="{{ config('global.settings')->collection_path }}" class="img-fluid bg-img" alt="">
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="row margin-default">
    ...
    <div class="title1 section-t-space">
        <h2 class="title-inner1">@lang('site.latest_products')</h2>
    </div>
                ...
                @foreach ($products as $product)
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            @if ($product->discount_price)
                                <div class="lable-block">
                                    <span class="lable3">{{ $product->discount_percent }}</span>
                                    <span class="lable4">@lang('site.on_sale')</span>
                                </div>
                            @endif

                            <div class="front">
                                <a href="#"><img src="{{ $product->image_path . '/' . $image[0] }}"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="{{ $product->image_path . '/' . $image[1] }}"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                        ...
                        <div class="product-detail">
                            ...
                            @if ($product->discount_price)
                                <h4>{{ number_format($product->discount_price, 2) }} @lang('site.currency')

                                    <del>{{ number_format($product->selling_price, 2) }} @lang('site.currency')</del>
                                </h4>
                            @else
                                <h4>{{ number_format($product->selling_price, 2) }} @lang('site.currency')</h4>
                            @endif
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="{{ config('global.settings')->banner_path }}" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="banner-contain">
                            ...
                            @if (app()->getLocale() == 'ar')
                                <h3>{{ config('global.settings')->banner_title_ar }}</h3>
                                <h4>{{ config('global.settings')->banner_description_ar }}</h4>
                            @else
                                <h3>{{ config('global.settings')->banner_title_en }}</h3>
                                <h4>{{ config('global.settings')->banner_description_en }}</h4>
                            @endif
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="title1 section-t-space">
                    <h2 class="title-inner1">@lang('site.latest_articles')</h2>
                </div>
            </div>
        </div>
    </div>

    <section class="blog pt-0 ratio2_3 pb-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>@lang('site.shipping')</h4>
                            <p>@lang('site.to_all_governments')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>@lang('site.24_service')</h4>
                            <p>@lang('site.to_all_customers')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>@lang('site.special_offers')</h4>
                            <p>@lang('site.all_year_round')</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($brands as $brand)
                            <div>
                                <div class="logo-block">
                                    <a href="javascript:void(0);"><img src="{{ $brand->image_path }}"
                                            alt="{{ $brand->name }}"></a>
                                </div>
                            </div>
                        @endforeach
