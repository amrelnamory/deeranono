...
class CreateThirdParty extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.contracts.create-third-party', compact('clients', 'cars'));
    }
    ...
    public function store()
    {
        ...
        if ($found->count() > 0) {
            ...
            Contract::create([
                ...
                'contract_type' => 'third_party_insurance',
